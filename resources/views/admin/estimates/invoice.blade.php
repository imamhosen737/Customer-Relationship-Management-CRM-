                    ...
                    <div class="form-row flex-nowrap">
                        <div class="form-group col-md-6">
                            ...
                            <select id="customer_name" class="custom-select" name="customer_id" required>
                                    ...
                                    <option value="{{ $customer->id }}" {{ "selected" }}>{{ $customer->user->name }}</option>
                                </select>
                            ...
                            <div class="table-responsive ">
                                <table class="table " id="invoice-table" style="width:100%">
                                    ...
                                    <tbody class="invoice-item-tbody py-2">
                                        ...
                                        $taxRule = $item->Item->tax->rules ?? '0' ;
                                        $taxCount =  ($amount *  ($taxRule/100));
                                        $tax += $taxCount;

                                        $discountRule = $discountCount ?? '0' ;
                                        $discountCount = ($amount *  ($discountRule/100));
                                        $dis += $discountCount;
                                        
                                        $grandTotal = $sub + $tax + $dis;
                                        @endphp
                                    <tr>
                                        <td style="padding-left:0 !important" class="col-md-2">
                                        <input type="text" readonly class="form-control" name="item_name[]"   value="{{ $item->item->name }}">
                                        <input type="hidden"  name="item_id[]"   value="{{ $item->item->id }}">
                                        </td>
                                        <td style="padding-left:0 !important" class="col-md-1">
                                        <input type="number" id="quantity-' + data.id +
                                        '" class="form-control qty-custom" name="qty[]"  value="{{ $item->qty }}">
                                        </td>
                                        <td style="padding-left:0 !important" class="col-md-2">
                                        <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        '"  class="form-control price-custom"  name="rate[]"  value="{{ $item->price }}">
                                        ...
                                        '"   class="form-control tax-custom" name="tax[]"   value="{{  $taxRule?? '0' }}">
                                        ...
                                        <input type="text" readonly class="form-control total-custom net-amount" name="amount[]"  value="{{ $amount }}">
                                        </div>
                                        </td>
                                        <td style="padding-left:0 !important" class="col-md-1">
                                        ...
                                        <tr class="text-right">
                                            ...
                                            <td><input type="text" readonly class="form-control subTotal" value=" {{ $sub }}"></td>
                                        </tr>
                                        <tr class="text-right">
                                            <td colspan="5"><strong>Total Tax</strong></td>
                                            <td><input type="text" readonly class="form-control subTax" value="{{ $tax }}"></td>
                                        </tr>
                                        <tr class="text-right">
                                            <td colspan="5"><strong>Total Discount</strong></td>
                                            <td><input type="text" readonly class="form-control total-discount" value="{{ $dis }}">
                                            </td>
                                        </tr>
                                        <tr class="text-right">
